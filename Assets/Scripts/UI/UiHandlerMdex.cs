...
public class UiHandlerMdex : MonoBehaviour
{
    ...
    public GameObject SwapToBalText;
    public GameObject SwapFromBalText;
    public GameObject SwapToNameInp;
    public GameObject SwapFromNameInp;

    public GameObject MdexUI;
    ...
    //     Debug.Log(symbol);
    //     SwapFromNameInp.GetComponent<TMP_InputField>().text = symbol;
    //     SwapFromBalText.GetComponent<TMP_InputField>().text = balanceOf.ToString();
    // }
    ...
    //     Debug.Log(symbol);
    //     SwapToNameInp.GetComponent<TMP_InputField>().text = symbol;
    //     SwapToBalText.GetComponent<TMP_InputField>().text = balanceOf.ToString();
    // }
    ...
    public void Swap()
    {
        // Debug.Log("SwapFromName " + SwapFromNameInp.GetComponent<TMPro.TextMeshProUGUI>().text);
        Debug.Log("SwapFromName " + SwapFromNameInp.GetComponent<TMPro.TextMeshProUGUI>().text +
                " SwapFromInput " + SwapFromBalText.GetComponent<TMPro.TextMeshProUGUI>().text +
                " SwapToName " + SwapToNameInp.GetComponent<TMPro.TextMeshProUGUI>().text +
                " SwapToInput " + SwapToBalText.GetComponent<TMPro.TextMeshProUGUI>().text);
        SwapCall(SwapFromNameInp.GetComponent<TMPro.TextMeshProUGUI>().text,
                SwapFromBalText.GetComponent<TMPro.TextMeshProUGUI>().text,
                SwapToNameInp.GetComponent<TMPro.TextMeshProUGUI>().text,
                SwapToBalText.GetComponent<TMPro.TextMeshProUGUI>().text);
    ...
    async public void SwapCall(string SwapFromName, string SwapFromInput, string SwapToName, string SwapToInput)
    {
        ...
        // gas limit OPTIONAL
        string gas = "21000";
        string contract = "0x64ff637fb478863b7468bc97d30a5bf3a428a1fd";

        // connects to user's browser wallet (metamask) to send a transaction
        try
        {
            string balance = await EVM.BalanceOf("heco", "mainnet", contract, "0x8AFEB0EFB6c3245D59d367a8595C23B4f068517a");
    ...
    public void ToggleMdexUI()
    {
        if (MdexUI.activeSelf == true)
        {
            MdexUI.SetActive(false);
        }
        else
        {
            MdexUI.SetActive(true);
        }
    }
