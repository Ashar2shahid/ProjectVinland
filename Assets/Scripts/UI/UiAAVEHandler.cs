...
//     }
//     public void ReadBorrowAmountFromInput(string s){
//         BorrowAmount = s;
//         Debug.Log("Borrow amount" + BorrowAmount);
//     }
//     public void ReadBorrowFromInput(string s){
//         BorrowAddress = s;
//         Debug.Log("Borrow Input" + BorrowAddress);
//     }
//     public void Deposit( ){
//         DepositCall(DepositAddress, DepositAmount);
//     }
//     public void Borrow( ){
//         BorrowCall(BorrowAddress, BorrowAmount);
//     }
...
//     async public void BorrowCall(string AssetAddress, string AssetAmount){
//         // insert deposit function
//         string method = "borrow";
//         BigInteger BorrowAmount2 = BigInteger.Parse(BorrowAmount);
//         string args = $"[\"{BorrowAddress}\", \"{BorrowAmount2}\" , \"0x4d67aA3D291a17538888D1BdB47aA6D12C52cc71\" , \"0\"]";
