...
using System;
public class UIHandlerSushi : MonoBehaviour
{
   ...
   public void ReadSwapFromInput(string s){
    ...
    public void ToggleSushiUI(){
        if(SushiUI.activeSelf == true){
